...
SDK durable writers use the shared `MAX_WRITER_IN_FLIGHT_RECORDS` and `MAX_WRITER_IN_FLIGHT_BYTES` window. It bounds records that have been sent but not acknowledged.
